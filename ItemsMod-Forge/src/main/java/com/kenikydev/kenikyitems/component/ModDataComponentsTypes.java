package com.kenikydev.kenikyitems.component;
...
public class ModDataComponentsTypes {
    public static final DeferredRegister<DataComponentType<?>> DATA_COMPONENT_TYPES = DeferredRegister.create(Registries.DATA_COMPONENT_TYPE, KenikyItems.MODID);
